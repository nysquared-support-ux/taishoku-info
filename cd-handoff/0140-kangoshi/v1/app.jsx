      ...
      <div style={{
        ...
        <div>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 18 }}>
            ...
            <Pill tone="line">24時間 LINE 受付</Pill>
  ...
  const axes = [
    {
      ...
      icon: Icon.clock,
      title: "24時間対応の窓口があるか",
      body: "看護師の生活時間は24時間体制。深夜の夜勤明けや早朝の決断にも、その場でチャットを返せる窓口かを確認します。LINE / 電話 / フォームの応答時間が明記されているサービスを優先します。",
      checks: [
        "深夜・早朝のLINE自動応答ではなく、人による返信時間が明記されている",
  ...
  const items = [
    {
      ...
      a: "24時間対応を明示しているサービスであれば、深夜・早朝のLINE受付が可能です。ただし「受付」と「実際の着手」は別物のため、職場への第一報を入れる時間帯(始業時間帯など)を依頼者と擦り合わせる運用が一般的です。受付時間と着手タイミングは事前に必ず確認してください。",
    },
    {
    ...
    <section id="faq" style={{ padding: "64px 20px", background: C.bg }}>
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        <SectionHeader
          ...
          lead="編集部に多く寄せられる質問を一般化してまとめました。個別の状況によって回答は変わりうるため、詳細はLINE相談で個別にご確認ください。"
        />
  ...
  return (
    <section id="cta" style={{
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", position: "relative", textAlign: "center" }}>
        <Pill tone="line"><span style={{ color: C.brandDeep }}>看護師専用 LINE 窓口</span></Pill>
        <h2 style={{
          fontFamily: "'Noto Serif JP', serif",
        ...
        <p style={{
          ...
          相談料は無料です。「辞めるかどうか」を含めて、迷っている段階でも構いません。LINEに登録いただいた後、看護師の事情に詳しい担当者から、24時間以内にご連絡いたします。
        </p>
  ...
  return (
    <div style={{
      ...
      <a href="#cta" style={{
        ...
        boxShadow: "0 10px 24px rgba(6,199,85,0.4)",
        width: "100%", maxWidth: 360,
      }}>
        {Icon.chat(18)} LINE で無料相談する (24時間)
      </a>
    </div>
  );
}
