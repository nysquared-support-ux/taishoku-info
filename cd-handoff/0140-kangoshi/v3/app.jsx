  ...
  return (
    <header style={{
      ...
      <div style={{
        ...
        <a href="https://h.accesstrade.net/sp/cc?rk=0100q2uz00ormk" target="_blank" rel="sponsored noopener nofollow" referrerPolicy="no-referrer-when-downgrade" style={{
          display: "inline-flex", alignItems: "center", gap: 6,
          background: "#0E7490", color: "#fff", textDecoration: "none",
          padding: "8px 14px", borderRadius: 8, fontSize: 13, fontWeight: 700,
        }}>
          {Icon.chat(15)} 無料相談
          <img src="https://h.accesstrade.net/sp/rr?rk=0100q2uz00ormk" width="1" height="1" alt="" style={{position:"absolute",visibility:"hidden"}} />
        </a>
      </div>
    </header>
  );
    ...
    <section id="top" style={{
      ...
      <div style={{
        ...
        <div>
          ...
          {/* バナー 250x250 (アクセストレード 1215855・退職代行 Jobs) */}
          <div style={{ marginTop: 24, display: "flex", justifyContent: "center" }}>
            <a href="https://h.accesstrade.net/sp/cc?rk=0100q25r00ormk" target="_blank" rel="sponsored noopener nofollow" referrerPolicy="no-referrer-when-downgrade">
              <img src="https://h.accesstrade.net/sp/rr?rk=0100q25r00ormk" alt="退職代行Jobs - 24時間対応・全額返金保証" width="250" height="250" style={{display:"block",border:0,maxWidth:"100%",height:"auto"}} />
            </a>
          </div>
